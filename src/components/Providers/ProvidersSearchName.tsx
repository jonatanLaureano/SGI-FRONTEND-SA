...
interface ProvidersSearchByNameProps {
  searchName: string;
  onChange: (event: React.ChangeEvent<HTMLInputElement>) => void;
}

const ProvidersSearchByName: React.FC<ProvidersSearchByNameProps> = ({ searchName, onChange }) => {
  return (
...
export default ProvidersSearchByName;