    ...
    <div className="flex">
      ...
      <main className="flex-1 bg-white overflow-auto">
        ...
        <div className="p-4 flex items-center justify-center mt-32 h-100">
          <div className="bg-AzulSidebar p-8 rounded-xl shadow-lg w-full max-w-md">
            ...
            <form className="space-y-4">
              ...
              <div className="flex justify-center mt-4">
                <button type="submit" className="bg-botonAgregar text-white py-2 px-6 rounded mx-2 hover:bg-green-600">
                  Guardar
                </button>
                <button type="button" className="bg-red-500 text-white py-2 px-6 rounded mx-2 hover:bg-red-600">
                  Cancelar
                </button>
              </div>
            </form>
